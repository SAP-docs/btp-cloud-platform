...
SaaS application providers can now use the new subscription management dashboard tool to manage their multitenant application's subscriptions.
...
> ### Note:  
> To assign a role collection, you must be either the owner of the global account in which the application is deployed or a subaccount admin.
...
Your subscription dependencies are shown in a tree or table view. See the following image for the tree view representation:
