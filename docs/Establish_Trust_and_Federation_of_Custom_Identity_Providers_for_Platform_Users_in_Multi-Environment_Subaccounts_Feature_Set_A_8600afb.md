...
4.  Open a ticket with SAP Support \(for the component, see [Monitoring and Troubleshooting](Monitoring_and_Troubleshooting_1b3e89e.md)\) and provide the following information:
