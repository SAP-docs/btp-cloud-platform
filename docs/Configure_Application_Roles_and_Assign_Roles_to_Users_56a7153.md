...
Your subaccount is subscribed to a multitenant application in the Cloud Foundry environment. See [Subscribe to Multitenant Applications Using the Cockpit](Subscribe_to_Multitenant_Applications_Using_the_Cockpit_7a3e396.md).
...
You can use any SAML 2.0 standard compliant identity provider. See [Trust and Federation with Identity Providers](Trust_and_Federation_with_Identity_Providers_cb1bc8f.md).

 <a name="loio56a71531fc154717bf221f9e293ba215 task_fqg_rdl_3cb__task_fqg_rdl_3cb"/>
...
1.  Navigate to your subaccount. For more information, see [Navigate in the Cockpit](Navigate_in_the_Cockpit_0874895.md).
...
4.  Open the tab *Roles* to view, create, and modify the application roles.
 ...
 <a name="loio56a71531fc154717bf221f9e293ba215 task_vvv_12l_3cb__task_vvv_12l_3cb"/>
