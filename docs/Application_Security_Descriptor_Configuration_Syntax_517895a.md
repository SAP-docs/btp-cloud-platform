...
> ### Recommendation:  
> We recommend that you configure allowed identity providers on subaccount level. For more information, see [Provide Logon Link Help to Identity Provider for Business Users](Provide_Logon_Link_Help_to_Identity_Provider_for_Business_Users_b8c0aac.md).
