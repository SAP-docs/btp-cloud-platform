...
-   You are assigned the developer role **or** you have a service key in JSON format. See [Assigning the ABAP Developer User to the ABAP Developer Role](../20_getting_started/assigning-the-abap-developer-user-to-the-abap-developer-role-13b2cfb.md) and [Creating Service Keys](creating-service-keys-4514a14.md).
