...
> ### Note:  
> For information about getting an application access token for the APIs of SAP Software-as-a-Service Provisioning service, see [Getting an Application Access Token](Getting_an_Application_Access_Token_6391b5d.md).
