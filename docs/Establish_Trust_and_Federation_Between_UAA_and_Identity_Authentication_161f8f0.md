...
> 
> Also, when the chosen Identity Authentication service tenant has a custom domain, the trust works only when the server certificate of the IAS tenant has been issued by a trusted CA. See [Trusted Certificate Authentication](Trusted_Certificate_Authentication_790cb76.md) for more information.
