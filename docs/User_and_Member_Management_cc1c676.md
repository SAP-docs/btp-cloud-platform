...
For platform users, the default identity provider is [SAP ID Service](SAP_ID_Service_d6a8db7.md). In cloud management tools feature set A, to use subaccount members from your own user base, use your own tenant of SAP Cloud Identity Services - Identity Authentication.
...
See [Add Members to Your Global Account](Add_Members_to_Your_Global_Account_4a04913.md).
...
See [Managing Security Administrators in Your Subaccount \[Feature Set A\]](Managing_Security_Administrators_in_Your_Subaccount_Feature_Set_A_6752c4b.md)
...
To learn more about user management, see [Security Administration: Managing Authentication and Authorization](Security_Administration_Managing_Authentication_and_Authorization_1ff47b2.md).
...
[Roles and Role Collections](Roles_and_Role_Collections_14a877c.md "Usually a role collection consists of one or multiple roles. You can use the SAP BTP cockpit to add or remove roles.")
