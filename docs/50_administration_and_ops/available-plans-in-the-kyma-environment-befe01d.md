...
Defines a region \(set of datacenters\) where your cluster will run. The possible values are `eastus`, `centralus`, `westus2`, `uksouth`, `northeurope`, `westeurope`, `japaneast`, `southeastasia`.
