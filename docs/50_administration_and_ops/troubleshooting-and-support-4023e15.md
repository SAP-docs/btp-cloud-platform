...
If you don't know how to get started, you might want to have a look at the appropriate workflow: [Setting Up a Trial Account via the Command Line \[Feature Set B\]](../20_getting_started/setting-up-a-trial-account-via-the-command-line-feature-set-b-a21360f.md) or [Setting Up a Global Account via the Command Line \[Feature Set B\]](../20_getting_started/setting-up-a-global-account-via-the-command-line-feature-set-b-accd5b2.md).
...
See [Getting Support](../70_getting_support/getting-support-5dd7398.md).
