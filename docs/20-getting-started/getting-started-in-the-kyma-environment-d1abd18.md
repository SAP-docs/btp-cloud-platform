...
-   To perform administrative and development tasks, you need a global account and one or several subaccounts for which you can provision the Kyma environment. For details, see [Creating Kyma Instances](../50-administration-and-ops/creating-kyma-instances-09dd313.md).
...
1.  Set up a Kubernetes cluster with the project "Kyma" to connect and extend SAP systems: [Creating Kyma Instances](../50-administration-and-ops/creating-kyma-instances-09dd313.md)
