...
To switch on the multi-availability zone option, set the parameter `multi_availability_zones` to `true`. See [Updating an ABAP System](updating-an-abap-system-7890ffa.md).
