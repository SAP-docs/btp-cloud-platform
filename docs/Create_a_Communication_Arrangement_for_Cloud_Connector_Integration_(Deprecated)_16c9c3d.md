...
6.  Click *Create* to proceed.
    ...
    *Outbound Communication* \> *User Name*
    ...
    For more information on how to create a communication arrangement, see [How to Create a Communication Arrangement](How_to_Create_a_Communication_Arrangement_a0771f6.md).
