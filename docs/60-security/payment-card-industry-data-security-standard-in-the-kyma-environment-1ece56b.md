...
To view the Responsibility Matrix, request access using the support procedure. To get support, report a case in SAP for Me with the `BC-CP-XF-KYMA` Kyma support component. For more information, see [Getting Support](https://help.sap.com/docs/btp/sap-business-technology-platform/btp-getting-support?version=Cloud#procedure).



## Registering Your Kyma Cluster for PCI DSS

To fulfill its part of the shared responsibilities, the Kyma team must be able to identify which Kyma clusters are in scope for PCI DSS.
