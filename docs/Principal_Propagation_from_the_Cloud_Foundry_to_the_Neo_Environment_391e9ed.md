...
-   Both accounts have a trust configuration to the same identity provider. See:
    ...
    -   [Establish Trust with Any SAML 2.0 Identity Provider in a Subaccount](Establish_Trust_and_Federation_with_UAA_Using_Any_SAML_Identity_Provider_2ce3938.md#loio8a213ea1a8664e6b96c0593e71339e0e) \(for the Cloud Foundry environment\)
