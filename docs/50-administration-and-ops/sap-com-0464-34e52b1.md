...
Learn how to establish a connection between the Analyze Custom Code/Custom Code Migration app running in an SAP BTP ABAP environment, with the customer's SAP ECC, SAP S/4HANA or SAP S/4HANA Cloud Private Edition ABAP system.
...
-   You have set up SAP cloud connector to use the Custom Code Migration app in the SAP BTP ABAP environment. See SAP note [2861842](https://me.sap.com/notes/2861842/E).
