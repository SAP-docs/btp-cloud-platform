...
If you don't know how to get started, you might want to have a look at the appropriate workflow: [Setting Up a Trial Account via the Command Line \[Feature Set B\]](../20-getting-started/Setting_Up_a_Trial_Account_via_the_Command_Line_Feature_Set_B_a21360f.md) or [Setting Up a Global Account via the Command Line \[Feature Set B\]](../20-getting-started/Setting_Up_a_Global_Account_via_the_Command_Line_Feature_Set_B_accd5b2.md).
...
See [Getting Support](../70-getting-support/Getting_Support_5dd7398.md).
