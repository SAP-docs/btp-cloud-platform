...
The audit log retrieval API allows you to retrieve the audit logs for your SAP BTP Cloud Foundry environment subaccount. It provides the audit log results as a collection of JSON entities.

The audit log retrieval API is protected by OAuth, and to consume it, you need your system to generate and use a valid OAuth.

Retrieving of audit logs via the Audit Log Retrieval API is limited to the size of the audit logs generated for the subaccount.
