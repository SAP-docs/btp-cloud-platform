...
The Audit Log Viewer is available for your SAP BTP Global Account and all your Cloud Foundry environment subaccounts.

-   To view the audit logs for your global account, open theSAP Audit Log Viewer service in the header of the Account Explorer.
-   To view the audit logs for a subaccount, open the SAP Audit Log Viewer service on the subaccount Overview page or in the subaccount Actions context menu in the Account Explorer.
