<!-- loio7047eb4a15a84ac7be3c8612179e6d1f -->
...
> ### Tip:  
> You can monitor costs and service usage throughout the contract period. See [Monitoring Usage and Consumption Costs in Your Global Account](../50_administration_and_ops/monitoring-usage-and-consumption-costs-in-your-global-account-de6f0db.md) and [View Subaccount Usage Analytics](../50_administration_and_ops/view-subaccount-usage-analytics-8f4d9db.md).
...
[View Subaccount Usage Analytics](../50_administration_and_ops/view-subaccount-usage-analytics-8f4d9db.md "You can explore, compare, and analyze all your actual usage data for the services and applications that are available in your subaccount.")
