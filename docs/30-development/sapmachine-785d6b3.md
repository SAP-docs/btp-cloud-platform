...
> 
> -   SAP Java Buildpack 1 had been deprecated and was **removed** from SAP BTP, Cloud Foundry environment in **January 2026**. See: [SAP Java Buildpack 1 – DEPRECATED!](sap-java-buildpack-1-deprecated-ad3e8df.md)
> 
...
-   For SAP Java Buildpack 2 – SapMachine JRE 21
...
> ### Tip:  
> SAP Java Buildpack 2 provides a customized SapMachine JRE 17 that contains a [jdk.compiler](https://docs.oracle.com/en/java/javase/11/docs/api/jdk.compiler/module-summary.html) module.
