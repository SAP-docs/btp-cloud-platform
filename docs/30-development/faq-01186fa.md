...
APIRule `v1beta1` deletion is divided into phases. As part of the first one, APIRule `v1beta1` support has been removed from Kyma dashboard. This means that you can no longer view, edit, or create APIRules `v1beta1` using Kyma dashboard. For more information on the deletion timeline for SAP BTP, Kyma runtime, see [f8df238618eb4858905c2b42fa4ec815.md\#loiof8df238618eb4858905c2b42fa4ec815\_\_section\_msj\_d2c\_hgc](apirule-migration-f8df238.md#loiof8df238618eb4858905c2b42fa4ec815__section_msj_d2c_hgc).
...
APIRule `v1beta1` deletion is divided into phases. In the second phase, you can no longer create APIRule `v1beta1` in new clusters. For more information on the deletion timeline for SAP BTP, Kyma runtime, see [f8df238618eb4858905c2b42fa4ec815.md\#loiof8df238618eb4858905c2b42fa4ec815\_\_section\_msj\_d2c\_hgc](apirule-migration-f8df238.md#loiof8df238618eb4858905c2b42fa4ec815__section_msj_d2c_hgc).
