...
[kyma-project.io: Using AzureRedisInstance Custom Resources](https://github.com/kyma-project/cloud-manager/blob/main/docs/user/tutorials/01-40-30-azure-redis-instance.md)
