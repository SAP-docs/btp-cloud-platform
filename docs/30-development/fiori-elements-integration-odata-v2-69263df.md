...
5.  Here are some examples for binding:
    ...
    After your app was deployed successfully to an SAP system, the *BSP application* and the *SAP Fiori Launchpad* app descriptor item will appear under your created package in Eclipse.
