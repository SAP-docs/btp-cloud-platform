...
> ### Tip:  
> See [sample Functions](https://kyma-project.io/external-content/serverless/docs/user/technical-reference/07-10-sample-functions.html) for each available runtime.
...
> ### Tip:  
> Read more about [Git Functions](https://kyma-project.io/external-content/serverless/docs/user/technical-reference/07-40-git-source-type.html).
