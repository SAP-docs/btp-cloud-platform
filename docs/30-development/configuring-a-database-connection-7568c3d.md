...
You can configure your application to use a database connection so that the application can persist its data. This configuration is applicable for the [Tomcat 9 – DEPRECATED!](tomcat-9-deprecated-ddfc101.md), [TomEE 7 – DEPRECATED!](tomee-7-deprecated-79c039a.md), and [Tomcat 10](tomcat-10-97d0e34.md) application containers. See:
