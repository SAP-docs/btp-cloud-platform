<!-- loioa490b2399b7c485b986505c0969dc782 -->

# Published Events Are Pending in the Stream



<a name="loioa490b2399b7c485b986505c0969dc782__section_yny_mjp_2hc"/>
...
<a name="loioa490b2399b7c485b986505c0969dc782__section_qhn_4jp_2hc"/>

## Cause

When the NATS `EventingBackend` has more than one replica, and the `Clustering` property on the NATS Server is enabled, a leader is elected for each stream and consumer \(see [NATS: JetStream Clustering](https://docs.nats.io/running-a-nats-service/configuration/clustering/jetstream_clustering)\). When the leader is elected, all the messages are replicated across the replicas.
...
<a name="loioa490b2399b7c485b986505c0969dc782__section_fdv_pjp_2hc"/>
