...
> ### Note:  
> Note: In the global account for development, you can use a booster \(see [Booster for Landscape Portal](booster-for-landscape-portal-8d34e0f.md)\) to automatically set up a subaccount with a working Landscape Portal subscription.
