<!-- loio7c854a11c6454fdc9735ccecffe50827 -->

# Tomcat 11

You can run your web applications on the Apache Tomcat 11 container.

The current default Tomcat version is 10. If you want your applications to run on Tomcat 11, you have to explicitly define it by using the TARGET\_RUNTIME environment variable in the application's `manifest.yml` file.
...
>   ...
>   env:
>     TARGET_RUNTIME: tomcat11
> ```



<a name="loio7c854a11c6454fdc9735ccecffe50827__section_lnr_2bv_42b"/>

## Provided APIs

The **tomcat11** application runtime container provides the following standard APIs:
...
Java Server Pages \(JSP\) 4.0

Expression Language \(EL\) 6.0

Debugging Support for Other Languages 2.0

Java API for WebSocket 2.2

Java Authentication Service Provider Interface for Containers \(JASPIC\) 3.1
...
<a name="loio7c854a11c6454fdc9735ccecffe50827__section_cq3_nbv_42b"/>

## Customize the buildpack defaults

SAP Java Buildpack 2 provides some default configurations for the Apache Tomcat 11 application container. They can be customized by the application with the [Resource Configuration](resource-configuration-c893e9c.md) feature.
...
<a name="loio7c854a11c6454fdc9735ccecffe50827__section_w3t_zc4_2fb"/>

## Configure the maximum number of active sessions

SAP Java Buildpack 2 provides the default configurations for unlimited sessions for the Apache Tomcat 11 application container. They can be customized by the application with the [Resource Configuration](resource-configuration-c893e9c.md) feature. To limit the number of active sessions, set the **`maxActiveSessions`** attribute of the `Manager` element in the application's `context.xml` file:
...
<a name="loio7c854a11c6454fdc9735ccecffe50827__section_i33_1d4_2fb"/>
...
<a name="loio7c854a11c6454fdc9735ccecffe50827__section_lbp_bw5_sfb"/>
...
> ...
>   env:
>     JBP_CONFIG_TOMCAT11: "[tomcat11:{app_context_root: test_context_path}]"
> ...
> ```
