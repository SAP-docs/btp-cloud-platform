...
**Required action**: Migrate your rules that rely on Oathkeeper mutators to use request modifiers or an external authorizer. For more information, see [External Authorization](https://kyma-project.io/external-content/api-gateway/docs/user/expose-workloads/extAuth/README.html).
...
**Required action**: Migrate your rules that use Opaque tokens to use an external authorizer. For more information, see [External Authorization](https://kyma-project.io/external-content/api-gateway/docs/user/expose-workloads/extAuth/README.html).
